...
import static com.fluxrpc.grpc.HelloGrpcGrpc.getServiceDescriptor;
...
public final class MutinyHelloGrpcGrpc implements io.quarkus.grpc.MutinyGrpc {
    ...
    public static class MutinyHelloGrpcStub extends io.grpc.stub.AbstractStub<MutinyHelloGrpcStub> implements io.quarkus.grpc.MutinyStub {
        ...
        public io.smallrye.mutiny.Uni<com.fluxrpc.grpc.HelloReply> sayHello(com.fluxrpc.grpc.HelloRequest request) {
    ...
    public static abstract class HelloGrpcImplBase implements io.grpc.BindableService {
        ...
        public io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(com.fluxrpc.grpc.HelloGrpcGrpc.getSayHelloMethod(), asyncUnaryCall(new MethodHandlers<com.fluxrpc.grpc.HelloRequest, com.fluxrpc.grpc.HelloReply>(this, METHODID_SAY_HELLO, compression))).build();
        }
    }
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_SAY_HELLO:
                    io.quarkus.grpc.stubs.ServerCalls.oneToOne((com.fluxrpc.grpc.HelloRequest) request, (io.grpc.stub.StreamObserver<com.fluxrpc.grpc.HelloReply>) responseObserver, compression, serviceImpl::sayHello);
                    break;
                default:
